...
function mapEmployeeDetailData(raw) {
  ...
  return {
    ...
    teamId:       (role === 'team_leader' ? (raw.led_team_id   || raw.team_id)   : (raw.team_id   || raw.led_team_id))   || null,
    teamName:     (role === 'team_leader' ? (raw.led_team_name || raw.team_name) : (raw.team_name || raw.led_team_name)) || null,
